            ...
            body: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(ImageConstant.img360view),
                        fit: BoxFit.cover)),
                child: Container(
                    width: double.maxFinite,
                    padding:
                        getPadding(left: 10, top: 13, right: 10, bottom: 13),
                    child: Column(
                        ...
                        children: [
                          CustomIconButton(
                              height: 50,
                              width: 50,
                              margin: getMargin(left: 15, top: 11),
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      getPadding(left: 14, top: 72, right: 14),
                                  child: Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        CustomButton(
                                            ...
                                            text: "Living Room",
                                            variant:
                                                ButtonVariant.FillBluegray700af,
            ...
            bottomNavigationBar: Container(
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                          padding: getPadding(
                              left: 16, top: 13, right: 33, bottom: 21),
                          child: Column(
                              mainAxisSize: MainAxisSize.min,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              mainAxisAlignment: MainAxisAlignment.start,
